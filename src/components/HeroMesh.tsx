...
export default function HeroMesh() {
  return (
    <svg viewBox="0 0 560 340" className="w-full max-w-[38rem] overflow-visible">
      ...
      <image href="/profile.jpg" x={PHOTO.cx - PHOTO.r} y={PHOTO.cy - PHOTO.r} width={PHOTO.r * 2} height={PHOTO.r * 2} preserveAspectRatio="xMidYMid slice" clipPath="url(#meshPhoto)" />
